...
public class PaymentOrderService {
    ...
    public PaymentOrderService(PaymentOrderRepository paymentOrderRepository, BookingRep bookingRepo, PaymentRep paymentRepo) {
    ...
    public PaymentOrder createOrder(Long userId) throws InvalidException {
        ...
        Booking booking = bookingRepo
                .findByUserIdAndStatus(userId, EnumStatusBooking.PENDING)
                .orElseThrow(() -> new InvalidException("Không có booking PENDING"));
    ...
    public int cancelExpiredOrders(int minutes) {
        ...
        var expiredOrders = paymentOrderRepository
                .findAllByStatusAndCreatedAtBefore(EnumStatusPayment.PENDING, cutoff);
    ...
    public Payment processVNPaySuccess(String orderCode)
        ...
        Booking booking = bookingRepo
                ...
                .orElseThrow(() -> new InvalidException("Không tìm thấy booking phù hợp"));
